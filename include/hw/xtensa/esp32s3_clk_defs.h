...
REG32(SYSTEM_CORE_1_CONTROL_1_REG, 0x004)

REG32(SYSTEM_CPU_PER_CONF, 0x010)
...
REG32(SYSTEM_PERIP_CLK_EN0, 0x018)
...
REG32(SYSTEM_PERIP_CLK_EN1, 0x01C)
...
REG32(SYSTEM_PERIP_RST_EN0, 0x020)
...
REG32(SYSTEM_PERIP_RST_EN1, 0x024)
...
REG32(SYSTEM_BT_LPCK_DIV_INT, 0x028)
    FIELD(SYSTEM_BT_LPCK_DIV_INT, BT_LPCK_DIV_NUM, 0, 12)

REG32(SYSTEM_BT_LPCK_DIV_FRAC, 0x02C)
...
REG32(SYSTEM_EXTERNAL_DEVICE_ENCRYPT_DECRYPT_CONTROL, 0x04C)
...
REG32(SYSTEM_RTC_FASTMEM_CONFIG, 0x050)
...
REG32(SYSTEM_COMB_PVT_LVT_CONF, 0x068)
...
REG32(SYSTEM_COMB_PVT_NVT_CONF, 0x06C)
...
REG32(SYSTEM_COMB_PVT_HVT_CONF, 0x070)
