/*
 * eFuse emulation for recent ESP32-series chip (ESP32-S3 and recent)
 *
...
/** Public helpers for the other modules */
 ...
 */
static inline uint32_t esp_efuse_get_key_purpose(ESPEfuseState *s, EfuseBlocksIdx efuse_block_num)
{
    uint32_t purpose = -1;
...
static inline void esp_efuse_get_key(ESPEfuseState *s, EfuseBlocksIdx efuse_block_num, uint8_t* efuse_key)
{
